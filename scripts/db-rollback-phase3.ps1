...
$sqlPath = Join-Path $root "infra/mysql/migrations/20260316_002_phase3_rbac_workbench_rollback.sql"
...
if ($LASTEXITCODE -ne 0) {
  throw "Phase 3 rollback failed."
}

Write-Host "Phase 3 rollback completed."
