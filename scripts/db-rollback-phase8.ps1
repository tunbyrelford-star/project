...
$sqlPath = Join-Path $root "infra/mysql/migrations/20260316_007_phase8_weighing_finance_closure_rollback.sql"
...
if ($LASTEXITCODE -ne 0) {
  throw "Phase 8 rollback failed."
}

Write-Host "Phase 8 rollback completed."
