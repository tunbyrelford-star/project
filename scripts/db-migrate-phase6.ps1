...
$sqlPath = Join-Path $root "infra/mysql/migrations/20260316_005_phase6_onsite_workflow_up.sql"
...
if ($LASTEXITCODE -ne 0) {
  throw "Phase 6 migration failed."
}

Write-Host "Phase 6 migration completed."
