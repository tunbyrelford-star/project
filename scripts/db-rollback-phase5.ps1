...
$sqlPath = Join-Path $root "infra/mysql/migrations/20260316_004_phase5_ship_position_rollback.sql"
...
if ($LASTEXITCODE -ne 0) {
  throw "Phase 5 rollback failed."
}

Write-Host "Phase 5 rollback completed."
