...
$sqlPath = Join-Path $root "infra/mysql/migrations/20260316_005_phase6_onsite_workflow_rollback.sql"
...
if ($LASTEXITCODE -ne 0) {
  throw "Phase 6 rollback failed."
}

Write-Host "Phase 6 rollback completed."
