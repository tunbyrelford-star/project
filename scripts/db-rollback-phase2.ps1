...
$sqlPath = Join-Path $root "infra/mysql/migrations/20260316_001_phase2_foundation_rollback.sql"
...
if ($LASTEXITCODE -ne 0) {
  throw "Phase 2 rollback failed."
}

Write-Host "Phase 2 rollback completed."
