...
$sqlPath = Join-Path $root "infra/mysql/migrations/20260316_008_phase9_governance_approval_version_report_up.sql"
...
if ($LASTEXITCODE -ne 0) {
  throw "Phase 9 migration failed."
}

Write-Host "Phase 9 migration completed."
