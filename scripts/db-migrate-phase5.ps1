...
$sqlPath = Join-Path $root "infra/mysql/migrations/20260316_004_phase5_ship_position_up.sql"
...
if ($LASTEXITCODE -ne 0) {
  throw "Phase 5 migration failed."
}

Write-Host "Phase 5 migration completed."
