...
$sqlPath = Join-Path $root "infra/mysql/migrations/20260316_001_phase2_foundation_up.sql"
...
if ($LASTEXITCODE -ne 0) {
  throw "Phase 2 migration failed."
}

Write-Host "Phase 2 migration completed."
