...
$sqlPath = Join-Path $root "infra/mysql/migrations/20260316_007_phase8_weighing_finance_closure_up.sql"
...
if ($LASTEXITCODE -ne 0) {
  throw "Phase 8 migration failed."
}

Write-Host "Phase 8 migration completed."
