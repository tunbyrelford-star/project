...
$sqlPath = Join-Path $root "infra/mysql/migrations/20260316_003_phase4_procurement_dispatch_rollback.sql"
...
if ($LASTEXITCODE -ne 0) {
  throw "Phase 4 rollback failed."
}

Write-Host "Phase 4 rollback completed."
