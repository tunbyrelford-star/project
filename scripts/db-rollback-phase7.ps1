...
$sqlPath = Join-Path $root "infra/mysql/migrations/20260316_006_phase7_sales_batch_allocation_rollback.sql"
...
if ($LASTEXITCODE -ne 0) {
  throw "Phase 7 rollback failed."
}

Write-Host "Phase 7 rollback completed."
